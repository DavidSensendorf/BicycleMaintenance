...
public class ServiceIntervals {
    ...
    private final int bicycleAgeShort = 0;
    private final int bicycleAgeNormal = 0;
    private final int bicycleAgeLong = 0;
    ...
    private final int cablesDistanceShort = 6437376;
    private final int cablesDistanceNormal = 9656064;
    private final int cablesDistanceLong = 12874752;
}
